...
# print("Done")
#
# user = UserModel("John", "Denver", first_name="John")
# user.email = "djohn2@company.org"
...
# print(user, user.email, user.last_updated)
# print("Done")
...
connection = Connection(host='http://dynamodb:8000')
